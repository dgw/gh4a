...
import com.meisolsson.githubsdk.model.MergeableState;
...
public class CommitStatusBox extends LinearLayoutCompat implements View.OnClickListener {
    ...
    public void fillStatus(List<Status> statuses, MergeableState mergableState) {
        ...
        if (mergableState == MergeableState.Unstable && pendingCount > 0) {
